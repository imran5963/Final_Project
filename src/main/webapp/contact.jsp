            ...
            <div class="row mb-3" id="banner">
                <div class="col-md-12 col-12 m-md-5 px-5 my-auto">
                    <div class="mx-md-5 my-5 mx-1 px-sm-0">
                        <h2 id="banner-heading" class="text-center">Contact Us</h2>
                    ...
                    <div class="container">
                        <div class="row my-5 py-2">
                           <div class="col-12">
                                <div class="row">
                                    <div class="col">
                                        <h3 class="d-flex justify-content-center justify-content-md-start" style="border-bottom: 3px solid #FF003C;">Contact Us</h3>
                                        <p class="text-center text-md-start mt-3 mb-0">Write us if you want to give suggestions, praise our work or have some query related to our products.</p>
                                        <div class="d-inline pull-left mt-4 mb-3 w-50 pe-2">
                                            <!-- <label for="exampleFormControlInput1" class="form-label"></label> -->
                                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Jhon Doe">
                                        </div>
                                        <div class="d-inline pull-right mt-4 mb-3 w-50 ps-2">
                                            <!-- <label for="exampleFormControlInput1" class="form-label"></label> -->
                                        ...
                                        <div class="d-grid d-md-block">
                                            <button type="button" class="btn btn-lg btn-dark button">Send Message</button>
                                        </div>
                                </div>
                            </div>
                           </div>
